...
const Carousel = () => {
  ...
  return (
    <div className="relative mx-auto w-full max-w-4xl" ref={carouselRef}>
      ...
      <button
        className="absolute top-1/2 left-4 z-10 -translate-y-1/2 rounded-full bg-white/80 p-3 shadow-lg transition-all duration-200 hover:scale-110 hover:bg-white"
        onClick={scrollPrev}
      ...
      <button
        className="absolute top-1/2 right-4 z-10 -translate-y-1/2 rounded-full bg-white/80 p-3 shadow-lg transition-all duration-200 hover:scale-110 hover:bg-white"
        onClick={scrollNext}
          ...
          {images.map((image, index) => (
            ...
            >
              <img
                ...
                className="aspect-square w-full origin-center rounded border border-gray-300 object-cover"
              />
            </div>
          ))}
        </div>
